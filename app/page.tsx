    ...
    <>
      ...
      <section className="relative isolate flex min-h-[calc(100svh-64px)] items-start overflow-hidden bg-navy pt-6 pb-16 text-white sm:pt-10 sm:pb-20">
        ...
        <div className="container-shell w-full">
          <p className="mb-2 font-display text-4xl font-bold sm:text-5xl lg:text-7xl xl:text-8xl">
          ...
          <h1 className="mt-3 font-display text-2xl font-bold leading-tight sm:text-4xl lg:text-6xl xl:text-7xl">
            Votre assurance,{" "}
