    ...
    <>
      ...
      <section className="section bg-navy text-white text-center border-t border-white/10">
        <div className="container-shell">
          ...
          <h2 className="mt-3 font-display text-3xl font-bold sm:text-4xl">Pas sûr de ce qu'il vous faut ?</h2>
          <p className="mt-4 text-white/70">Décrivez votre situation en quelques lignes, Ruby Assur' vous oriente.</p>
